...
/* The release number lives in package.json and nowhere else. It used to be duplicated in
   tokens.json, and the two had already drifted by one patch release before anyone read the
   banner they both feed. */
