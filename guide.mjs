...
<style>
/* ${PKG.name} v${PKG.version} — GENERATED by guide.mjs from tokens.json + guide.content.json +
   company.json. Do not edit; regenerate. Every value on this page was read or recomputed. */
